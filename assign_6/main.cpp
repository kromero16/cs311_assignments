...
int main() {
    ...
    do
    {
        ...
        case 1:
            ...
            cin >> val;
            heapPtr->insert(heapPtr, val);
            break;

        case 2:
            cout << "The maximum value removed is: " << heapPtr->removeMax(heapPtr) << "\n";
            heapPtr->printHeap(heapPtr);
            break;

        case 3:
            cout << "The maximum value is: " << heapPtr->getMax(heapPtr) << "\n";
            heapPtr->printHeap(heapPtr);
            break;
        ...
        case 4:
            ...
            cin >> i >> val;
            heapPtr->decreaseKey(heapPtr, i, val);
            break;
